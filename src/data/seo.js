...
const pageConfigs = {
  "/": {
    title: "SG Holidays Vagamon | Resort Stay, Jeep Safari & Tour Packages",
    heading: "SG Holidays Vagamon",
    breadcrumb: "Home",
    description:
      "Book resort stays, jeep safari rides, honeymoon plans, family packages, and group trips in Vagamon with SG Holidays.",
    keywords: [
      ...sharedKeywords,
    ...
    primaryImage: "/assets/hero-forest-cabin.jpg",
    webPageType: "WebPage",
  },
  "/resort": {
    title: "Resort Stay in Vagamon | Rooms, Cottages & Dormitory Booking | SG Holidays",
    heading: "Resort Stay in Vagamon",
    breadcrumb: "Resort",
    description:
      "Explore SG Holidays resort stay options in Vagamon including private rooms, cottages, pool rooms, and dormitory stays for couples, families, and groups.",
    keywords: [
      ...sharedKeywords,
    ...
    image: siteConfig.defaultOgImage,
    imageAlt: siteConfig.defaultOgImageAlt,
    primaryImage: "/assets/room-suite-1.jpg",
  ...
  "/packages": {
    ...
    image: siteConfig.defaultOgImage,
    imageAlt: siteConfig.defaultOgImageAlt,
    primaryImage: "/assets/room-family-1.jpg",
    webPageType: "CollectionPage",
  ...
  "/contact": {
    ...
    image: siteConfig.defaultOgImage,
    imageAlt: siteConfig.defaultOgImageAlt,
    primaryImage: "/assets/hero-safari-savanna.jpg",
...
function buildBusinessSchema(origin = "") {
  ...
  return {
    ...
    image: [
      ...
      buildUrl("/assets/hero-forest-cabin.jpg", origin),
    ],
